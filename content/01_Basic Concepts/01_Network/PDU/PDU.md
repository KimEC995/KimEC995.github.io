...
#### 네트워크 계층(L3)의 헤더(IP)
[[OSI 7 Layer & TCP,IP 4 Layer|네트워크 계층(L3)]]에서 [[세그먼트]]앞에 붙이는 메타데이터. [[IP - Internet Protocol|IP]]헤더 라고도 한다. **호스트간 주소 지정 및 [[Routing Protocol|라우팅]] 정보** 그리고 **[[패킷]]의 생존 시간**이 저장되어있다.
